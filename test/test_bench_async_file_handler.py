...
@pytest.mark.asyncio
@pytest.mark.parametrize("num_files", BATCH_TEST_CASES)
async def test_benchmark_async_file_handler_write_no_flush(benchmark, num_files, tmp_path):
    """Benchmark test for writing to multiple files."""
    file_paths: List[Path] = temporary_file_handler(num_files, tmp_path)
    ...
    result = await benchmark(write_logs_async)
...
@pytest.mark.asyncio
@pytest.mark.parametrize("num_files", BATCH_TEST_CASES)
async def test_benchmark_async_cm_file_handler_write_no_flush(benchmark, num_files, tmp_path):
    """Benchmark test for writing to multiple files."""
    file_paths: List[Path] = temporary_file_handler(num_files, tmp_path)
